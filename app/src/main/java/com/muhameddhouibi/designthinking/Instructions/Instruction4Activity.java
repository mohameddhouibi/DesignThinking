        ...
        manager = new CardStackLayoutManager(this, new CardStackListener() {
            ...
            public void onCardSwiped(Direction direction) {
                ...
                if (direction == Direction.Right){
                    Toast.makeText(Instruction4Activity.this, "Direction Right", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Top){
                    Toast.makeText(Instruction4Activity.this, "Direction Top", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Left){
                    Toast.makeText(Instruction4Activity.this, "Direction Left", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Bottom){
                    Toast.makeText(Instruction4Activity.this, "Direction Bottom", Toast.LENGTH_SHORT).show();
                }
