...
public class Instruction6Activity extends AppCompatActivity {
        ...
        manager = new CardStackLayoutManager(this, new CardStackListener() {
            ...
            public void onCardSwiped(Direction direction) {
                ...
                if (direction == Direction.Right){
                    Toast.makeText(Instruction6Activity.this, "Direction Right", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Top){
                    Toast.makeText(Instruction6Activity.this, "Direction Top", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Left){
                    Toast.makeText(Instruction6Activity.this, "Direction Left", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Bottom){
                    Toast.makeText(Instruction6Activity.this, "Direction Bottom", Toast.LENGTH_SHORT).show();
                }
