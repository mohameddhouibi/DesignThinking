...
public class Instruction9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instruction9);
        ...
        manager = new CardStackLayoutManager(this, new CardStackListener() {
            ...
            public void onCardSwiped(Direction direction) {
                ...
                if (direction == Direction.Right){
                    Toast.makeText(Instruction9Activity.this, "Direction Right", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Top){
                    Toast.makeText(Instruction9Activity.this, "Direction Top", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Left){
                    Toast.makeText(Instruction9Activity.this, "Direction Left", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Bottom){
                    Toast.makeText(Instruction9Activity.this, "Direction Bottom", Toast.LENGTH_SHORT).show();
                }
