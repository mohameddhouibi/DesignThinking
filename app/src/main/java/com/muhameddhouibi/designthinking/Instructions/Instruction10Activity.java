...
public class Instruction10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instruction10);
        ...
        manager = new CardStackLayoutManager(this, new CardStackListener() {
            ...
            public void onCardSwiped(Direction direction) {
                ...
                if (direction == Direction.Right){
                    Toast.makeText(Instruction10Activity.this, "Direction Right", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Top){
                    Toast.makeText(Instruction10Activity.this, "Direction Top", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Left){
                    Toast.makeText(Instruction10Activity.this, "Direction Left", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Bottom){
                    Toast.makeText(Instruction10Activity.this, "Direction Bottom", Toast.LENGTH_SHORT).show();
                }
