...
public class Chat10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat10);
        ...
        tutor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //////
                Toast.makeText(Chat10Activity.this, "Tutor is in his way to join the discussion wait for him! ", Toast.LENGTH_LONG).show();
        ...
        finalDecision.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                confbtn1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        DatabaseReference rrf =FirebaseDatabase.getInstance().getReference("Workshops").child(discussion).child("Step10")
                                .child("FinalDecision");;
                        ...
                        if(aaa.equals(""))
                        {
                            Toast.makeText(Chat10Activity.this, "can't add an Empty value ! ", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            rrf.setValue(aaa);
                            Toast.makeText(Chat10Activity.this, "Final decission added successfully :) ", Toast.LENGTH_SHORT).show();
                            Infodiaog2.dismiss();
                        }
                    }
                });
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Chat10Activity.this,discussion,Toast.LENGTH_SHORT).show();
                }else
                {
                    sendMessage(message);
    ...
    private void loadGroupeMessages() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Workshops").child(discussion).child("Step10").child("Discussion");
        ref.child("Messages")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        adapterGroupChat = new AdapterGroupChat(Chat10Activity.this,chatGroupList);
    ...
    private void sendMessage(String message)
    {
        ...
        ref.child("Messages").child(timestamp).setValue(hashMap)
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Chat10Activity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
