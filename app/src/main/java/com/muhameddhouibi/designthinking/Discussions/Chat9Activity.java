...
public class Chat9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tutor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //////
                Toast.makeText(Chat9Activity.this, "Tutor is in his way to join the discussion wait for him! ", Toast.LENGTH_LONG).show();
        ...
        finalDecision.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                confbtn1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        DatabaseReference rrf =FirebaseDatabase.getInstance().getReference("Workshops").child(discussion).child("Step9")
                                .child("FinalDecision");;
                        ...
                        if(aaa.equals(""))
                        {
                            Toast.makeText(Chat9Activity.this, "can't add an Empty value ! ", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            rrf.setValue(aaa);
                            Toast.makeText(Chat9Activity.this, "Final decission added successfully :) ", Toast.LENGTH_SHORT).show();
                            Infodiaog2.dismiss();
                        }
                    }
                });
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Chat9Activity.this,discussion,Toast.LENGTH_SHORT).show();
                }else
                {
                    sendMessage(message);
    ...
    private void loadGroupeMessages() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Workshops").child(discussion).child("Step9").child("Discussion");
        ref.child("Messages")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        adapterGroupChat = new AdapterGroupChat(Chat9Activity.this,chatGroupList);
    ...
    private void sendMessage(String message)
    {
        ...
        ref.child("Messages").child(timestamp).setValue(hashMap)
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Chat9Activity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
