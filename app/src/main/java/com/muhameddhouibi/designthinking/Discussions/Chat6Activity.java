...
public class Chat6Activity extends AppCompatActivity {
        ...
        finalDecision.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                confbtn1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        DatabaseReference rrf =FirebaseDatabase.getInstance().getReference("Workshops").child(discussion).child("Step6")
                                .child("FinalDecision");
    ...
    private void loadGroupeMessages() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Workshops").child(discussion).child("Step6").child("Discussion");
        ref.child("Messages")
