...
public class Step6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Discussions=FirebaseDatabase.getInstance().getReference("Workshops").child(roomname).child("Step6").child("Discussion");
        mAuth = FirebaseAuth.getInstance();
        result.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Discussions.child("Step6").setValue(hashMap)
                .addOnSuccessListener(
                        new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Discussions.child("Step6").child("Participants").setValue(hashMap1);
