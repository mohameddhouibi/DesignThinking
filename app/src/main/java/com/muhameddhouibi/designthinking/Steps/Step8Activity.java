...
import com.muhameddhouibi.designthinking.Discussions.Chat8Activity;
import com.muhameddhouibi.designthinking.Instructions.Instruction5Activity;
import com.muhameddhouibi.designthinking.Instructions.Instruction8Activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        redo_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Step8Activity.this, Step9Activity.class);
        ...
        Instructions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Step8Activity.this, Instruction8Activity.class);
                i.putExtra("discussion",roomname+"Step8");
                startActivity(i);
                overridePendingTransition(0,0);
        ...
        Discussions=FirebaseDatabase.getInstance().getReference("Workshops").child(roomname).child("Step8").child("Discussion");
        mAuth = FirebaseAuth.getInstance();
        result.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Discussions.child("Step8").setValue(hashMap)
                .addOnSuccessListener(
                        new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Discussions.child("Step8").child("Participants").setValue(hashMap1);
        ...
        discussion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Step8Activity.this, Chat8Activity.class);
                i.putExtra("discussion",roomname);
                startActivity(i);
                overridePendingTransition(0,0);
            }
