    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        redo_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Step5Activity.this, Step6Activity.class);
        ...
        Instructions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Step5Activity.this, Instruction5Activity.class);
        ...
        Discussions=FirebaseDatabase.getInstance().getReference("Workshops").child(roomname).child("Step5").child("Discussion");
        mAuth = FirebaseAuth.getInstance();
        result.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        hashMap.put("StepNum","5");
        hashMap.put("RoomName",roomname);
        Discussions.child("Step5").setValue(hashMap)
                .addOnSuccessListener(
                        new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Discussions.child("Step5").child("Participants").setValue(hashMap1);
        ...
        discussion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Step5Activity.this, Chat5Activity.class);
                i.putExtra("discussion",roomname);
                startActivity(i);
                overridePendingTransition(0,0);
            }
