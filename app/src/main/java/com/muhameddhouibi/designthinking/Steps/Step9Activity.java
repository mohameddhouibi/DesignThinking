...
public class Step9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Discussions=FirebaseDatabase.getInstance().getReference("Workshops").child(roomname).child("Step9").child("Discussion");
        mAuth = FirebaseAuth.getInstance();
        result.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Discussions.child("Step9").setValue(hashMap)
                .addOnSuccessListener(
                        new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Discussions.child("Step9").child("Participants").setValue(hashMap1);
